  ...
  return (
    <View style={styles.container}>
      ...
      >
            ...
            <View style={styles.center}>
              ...
              <View style={styles.center}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => _changeStyle()}
                >
                  <View>
                    <Text>
                      Confirm Delivery by clicking :
                      <View
                        style={{
        ...
        <Text style={{ paddingLeft: 30, paddingTop: 20, fontWeight: "bold" }}>
          Ordered Items List
        </Text>
        <View style={styles.itemDetailcardWrapper2}>
          <View style={{ padding: 20 }}>
            <View style={styles.itemCardWrapOuter}>
              ...
              <View style={styles.itemcardRight}>
                <Image
                  source={{
                    uri: `https://m.media-amazon.com/images/I/61NDpj1AUWL._SX466_.jpg`,
                  }}
          ...
          <View style={{ padding: 20 }}>
            <View style={styles.itemCardWrapOuter}>
              ...
              <View style={styles.itemcardRight}>
                <Image
                  source={{
                    uri: `http://www.biopowerlanka.com/images/bio-gold.jpg`,
                  }}
                  style={styles.itemcardimage}
                />
              </View>
