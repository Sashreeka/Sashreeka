const plants = [
  {
    ...
    price: "39.99",
    like: true,
    img: require("./pictures/plant1.png"),
    about:
...

  {
    ...
    price: "29.99",
    like: false,
    img: require("./pictures/plant2.png"),
    about:
  ...
  },
  {
    ...
    price: "25.99",
    like: false,
    img: require("./pictures/plant3.png"),
    about:
...

  {
    ...
    price: "25.99",
    like: true,
    img: require("./pictures/plant4.png"),
    about:
  ...
  },
  {
    ...
    price: "50.99",
    like: true,
    img: require("./pictures/plant5.png"),
    about:
      "Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.",
  },
  {
    ...
    price: "50.99",
    like: false,
    img: require("./pictures/plant6.png"),
    about:
      "Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.",
  },
];
