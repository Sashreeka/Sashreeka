            ...
            <div className="container text-center text-md-left">
              <div className="row">
                <div className="col-md-3 mx-auto md-4">
                  ...
                  <p className="mt-2">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen booklorem</p>
                </div>
                ...
                <div className="col-md-3 mx-auto md-4">
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li className="my-2"><a href="#">Features</a></li>
                  </ul>
                </div>
